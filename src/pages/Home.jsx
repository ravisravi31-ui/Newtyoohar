...
// small images
import small1 from '../assets/small-1.webp';
import small2 from '../assets/small-2.webp';
import small3 from '../assets/small-3.webp';
// medium images
import medium1 from '../assets/medium-1.webp';
import medium2 from '../assets/medium-2.webp';
import medium3 from '../assets/medium-3.webp';
// large images
import large1 from '../assets/large-1.webp';
import large2 from '../assets/large-2.webp';
import large3 from '../assets/large-3.webp';

const HAMPERS = [
  {id:'small', title:'Small Hamper', price:'₹475', images:[small1, small2, small3]},
  {id:'medium', title:'Medium Hamper', price:'₹800', images:[medium1, medium2, medium3]},
  {id:'large', title:'Large Hamper', price:'₹1350', images:[large1, large2, large3]},
];

function Modal({open, onClose, hamper, onOrderClick, onEnquiryClick}){
  const [idx,setIdx]=React.useState(0);
  React.useEffect(()=>{ setIdx(0); }, [hamper]);
  if(!open) return null;
  return (
